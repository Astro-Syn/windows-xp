...
export default function HabboHotel({ goTo, goBack }: PageProps) {
  ...
  const [isVisible, setIsVisible] = useState(true);
      ...
      const [isDragging, setIsDragging] = useState(false);
          ...
          const images = [
      { src: "Images/habbo_1.png", name: "1" },
      { src: "Images/habbo_2.png", name: "2" },
      { src: "Images/habbo_3.png", name: "3" },
      { src: "Images/habbo_4.png", name: "4" },
          ...
          <div className="standard-title-bar" onMouseDown={onMouseDown}>
            <div className="header-logo-container">
              <img
                ...
                alt="Habbo Hotel"
              />
              <span className="desktop-bg-title">Habbo Hotel</span>
            </div>
